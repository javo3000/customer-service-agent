...
class AgentState(TypedDict):
    ...
    # Retry tracking for web search fallback
    retry_count: int  # Tracks reroute attempts (max 1)
    needs_web_search: bool  # Flag set by generate when context insufficient
    context_sufficient: bool  # LLM judgment on context quality
